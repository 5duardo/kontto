...
// Removed unused format options: decimal places, date formats and month start
...
export const FormatSettingsScreen = ({ navigation }: any) => {
    ...
    // Removed unused format example and date label helpers
    ...
    return (
        <View style={styles.container}>
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                {/* Formato and Período options removed (not used) */}
            ...
            {/* Decimal/Date/Month modals removed (not used) */}
        </View>
    );
};
